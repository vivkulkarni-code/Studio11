...
export const categoryImages: Record<string, number> = {
  ...
  'MANI PADI': require('../../../attached_assets/Mani-_Padi_1782099710395.png'),
  'MAKEUP': require('../../../attached_assets/Make-up_1782099710414.png'),
  'GROOMAL': require('../../../attached_assets/Groomal_1782099710464.png'),
  'BRIDAL': require('../../../attached_assets/Groomal_1782099710464.png'),
  'SPAS & MASSAGE': require('../../../attached_assets/Body_treatments_1782099710530.png'),
};
...
export const maleCategoryVideos: Record<string, number> = {
  ...
  'SKIN CARE': require('../../../attached_assets/Male_Skin_care_1782244651567.mp4'),
  'SKIN CARE_Mask': require('../../../attached_assets/Male_Skin_Care_Mask_1782364361339.mp4'),
  'FACIALS': require('../../../attached_assets/Male_Facials_1782244651523.mp4'),
  'MANI PADI': require('../../../attached_assets/Male-_Body_Spa_1782104764661.mp4'),
  'MAKEUP': require('../../../attached_assets/Male_Makeup_1782374586852.mp4'),
  'GROOMAL': require('../../../attached_assets/Male_Groomal_1782374586829.mp4'),
  'SPAS & MASSAGE': require('../../../attached_assets/Male-_Body_Spa_1782104764661.mp4'),
};
...
export const femaleCategoryVideos: Record<string, number> = {
  ...
  'BODY TREATMENTS': require('../../../attached_assets/InShot_20260621_224522079_1782062291405.mp4'),
  ...
  'MANI PADI': require('../../../attached_assets/grok_video_2026-06-17-14-00-05_1781685081657.mp4'),
  'MAKEUP': require('../../../attached_assets/Female_makeup_1782244651585.mp4'),
  'BRIDAL': require('../../../attached_assets/grok_video_2026-06-17-17-44-23_1781699536476.mp4'),
  'SPAS & MASSAGE': require('../../../attached_assets/Female_Body_spa_1782104764707.mp4'),
};
